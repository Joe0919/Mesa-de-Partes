    ...
    <div id="page_pdf">
      <table id="factura_head">
        <tr>
          <td>
            <div>
              <img style="padding-right: 120px" src="http://localhost/Sistema_MesaPartes/reporte/img/sello.jpg" width="80px" height="80px">
            </div>
          </td>
          ...
          <td>
            <div>
              <img style="padding-left: 120px"  src="http://localhost/Sistema_MesaPartes/reporte/img/logo.jpg" width="80px" height="80px">
            </div>
          </td>
        </tr>
      </table>
